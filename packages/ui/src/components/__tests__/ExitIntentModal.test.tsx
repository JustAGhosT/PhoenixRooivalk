...
describe('ExitIntentModal', () => {
  ...
  it('shows modal when mouse leaves the page', async () => {
    ...
    expect(screen.getByText('Wait! Get Our Technical Whitepaper')).toBeInTheDocument();
    expect(screen.getByText('Download our comprehensive technical documentation before you leave.')).toBeInTheDocument();
  });
  ...
  it('does not close modal when modal content is clicked', async () => {
    ...
    const modalContent = screen.getByText('Wait! Get Our Technical Whitepaper').closest('div');
