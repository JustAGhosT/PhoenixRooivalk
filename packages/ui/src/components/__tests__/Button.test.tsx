...
describe('Button', () => {
  ...
  it('renders with default props', () => {
    ...
    expect(button).toHaveClass('inline-block', 'rounded', 'font-bold', 'transition');
  ...
  it('renders with different variants', () => {
    ...
    expect(screen.getByRole('button')).toHaveClass('border-2', 'border-[var(--primary)]');
  });
  ...
  it('prevents navigation when disabled link is clicked', () => {
    const handleClick = jest.fn();
    render(<Button {...defaultProps} href="/test" disabled onClick={handleClick} />);
