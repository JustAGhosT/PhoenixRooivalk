            ...
            <div className="bg-[rgba(var(--primary),0.1)] p-8 rounded-xl border border-[var(--primary)]/20">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-[var(--gray)]">Certification</span>
                  <span className="text-yellow-400 font-semibold">Planned</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[var(--gray)]">Target Date</span>
                  <span className="text-yellow-400 font-semibold">Q4 2025</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[var(--gray)]">Implementation</span>
                  <span className="text-yellow-400 font-semibold">
                    In Progress
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[var(--gray)]">Next Milestone</span>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <span className="text-xs text-[var(--gray)]">Controls</span>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="text-center">
                ...
                <p className="text-[var(--gray)] text-sm">{step.description}</p>
              </div>
            ))}
          </div>
        </div>
