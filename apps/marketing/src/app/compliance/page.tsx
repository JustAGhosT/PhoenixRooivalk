        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={cert.title}
                className="rounded-xl border border-primary/20 bg-[rgba(15,23,42,0.8)] backdrop-blur p-6 text-center hover:border-primary/30 transition-all duration-300"
              >
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-[rgba(15,23,42,0.8)] rounded-full h-2 border border-primary/20">
                    <div
                  ...
                  className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${
                    cert.status === "Certified"
                      ...
                      : cert.status === "In Progress"
                        ? "bg-[rgba(var(--accent),0.2)] text-accent border border-accent/30"
                        : "bg-[rgba(var(--primary),0.2)] text-primary border border-primary/30"
                  }`}
                >
                  {cert.status}
                </div>
      ...
      <section className="px-[5%] py-16 bg-[linear-gradient(180deg,transparent,rgba(0,136,255,0.05))]">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="rounded-xl border border-[rgba(0,255,136,0.2)] bg-[rgba(15,23,42,0.8)] backdrop-blur p-6">
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-2xl mb-4">
                🔗
              </div>
