        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={cert.title}
                className="rounded-xl border border-[rgb(var(--primary))]/20 bg-[rgba(15,23,42,0.8)] backdrop-blur p-6 text-center hover:border-[rgb(var(--primary))]/30 transition-all duration-300"
              >
                ...
                {/* Progress Bar */}
                <div className="mb-4">
                  <div className="flex justify-between text-xs text-[rgb(var(--gray))] mb-2">
                    <span>Progress</span>
                    <span>{cert.progress}</span>
                  </div>
                  <div className="w-full bg-[rgba(15,23,42,0.8)] rounded-full h-2 border border-[rgb(var(--primary))]/20">
                    <div
                      className="h-2 rounded-full bg-gradient-to-r from-[rgb(var(--primary))] to-[rgb(var(--accent))] transition-all duration-1000 ease-out"
                  ...
                  className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${
                    cert.status === "Certified"
                      ...
                      : cert.status === "In Progress"
                        ? "bg-[rgba(var(--accent),0.2)] text-[rgb(var(--accent))] border border-[rgb(var(--accent))]/30"
                        : "bg-[rgba(var(--primary),0.2)] text-[rgb(var(--primary))] border border-[rgb(var(--primary))]/30"
                  }`}
                >
                  {cert.status}
                </div>
      ...
      <section className="px-[5%] py-16 bg-[linear-gradient(180deg,transparent,rgba(0,136,255,0.05))]">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="rounded-xl border border-[rgba(0,255,136,0.2)] bg-[rgba(15,23,42,0.8)] backdrop-blur p-6">
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[rgb(var(--primary))] to-[rgb(var(--secondary))] flex items-center justify-center text-2xl mb-4">
                🔗
              </div>
          ...
          <div className="rounded-xl border border-[rgba(0,255,136,0.2)] bg-[rgba(15,23,42,0.8)] backdrop-blur p-8">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2 text-[rgb(var(--gray))]">
