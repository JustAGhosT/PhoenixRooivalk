      ...
      <nav className="sticky top-0 z-50 bg-[rgba(10,14,26,0.95)] backdrop-blur px-6 py-4">
        <div className="mx-auto max-w-[1400px] flex items-center justify-between">
          ...
          <ul className="hidden md:flex gap-6 text-gray">
            ...
            <li>
              <Link href="/technical" className="hover:text-primary">
                Technical
              </Link>
            </li>
            <li>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="inline-block mt-3 rounded bg-gradient-to-br from-primary to-secondary px-4 py-2 font-bold text-dark shadow-glow hover:-translate-y-0.5 transition disabled:opacity-50"
                    disabled={!email}
                  >
                    Request Intro Call
                  </button>
                ...
                <div>
                  ...
                  <button
                    ...
                    className="inline-block mt-3 rounded border-2 border-primary px-4 py-2 font-bold text-primary hover:bg-[var(--primary)] hover:text-dark transition disabled:opacity-50"
                    disabled={!email}
                  >
                    Investment Inquiry
                  </button>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-2 py-1 bg-[rgba(var(--primary),0.2)] text-primary text-xs rounded">
                      TypeScript
                    </span>
                    <span className="px-2 py-1 bg-[rgba(var(--primary),0.2)] text-primary text-xs rounded">
                      Rust
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="w-full bg-primary text-black font-semibold py-3 px-6 rounded-lg hover:bg-primary/90 transition-colors"
                  >
                    Apply Now
                  </button>
                </div>
