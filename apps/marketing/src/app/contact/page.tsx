  ...
  return (
    <main className="relative overflow-hidden bg-[var(--darker)] text-white">
      ...
      <section className="px-[5%] py-16">
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-br from-white to-[var(--primary)]">Contact Phoenix Rooivalk</h1>
            <p className="text-[var(--gray)] mt-4 max-w-3xl mx-auto">Ready to deploy advanced counter-UAS defense? Get in touch for technical demonstrations and partnership opportunities.</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-[5%] py-16">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-[var(--gray)]">
                    <strong>Jurie Smit</strong><br/>
                    PhoenixVC<br/>
                    <a href="mailto:smit.jurie@gmail.com" className="text-[var(--primary)] hover:underline">smit.jurie@gmail.com</a>
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-2">Technical Demonstrations</h3>
                  <p className="text-[var(--gray)]">
                    Schedule a comprehensive technical demonstration showcasing multi-sensor detection, neutralization capabilities, and blockchain evidence logging.
                  </p>
                  <a href="mailto:smit.jurie@gmail.com?subject=Phoenix%20Rooivalk%20Technical%20Demo&body=I%20would%20like%20to%20schedule%20a%20technical%20demonstration%20of%20the%20Phoenix%20Rooivalk%20Counter-UAS%20System." 
                ...
                <div>
                  ...
                  <p className="text-[var(--gray)]">
                    Interested in distribution partnerships, system integration, or custom deployment configurations? Contact us for partnership opportunities.
                  </p>
                  <a href="mailto:smit.jurie@gmail.com?subject=Phoenix%20Rooivalk%20Partnership%20Inquiry" 
            ...
            <div className="rounded-xl border border-[rgba(0,255,136,0.2)] bg-[rgba(15,23,42,0.8)] backdrop-blur p-8">
              <h2 className="text-2xl font-bold mb-6 text-[var(--primary)]">Access Requirements</h2>
              <div className="space-y-6">
                <div>
                  <h3 className="font-semibold mb-2">Restricted Partner Access</h3>
                ...
                <div className="p-4 bg-[rgba(0,255,136,0.1)] rounded-lg border border-[rgba(0,255,136,0.3)]">
                  <p className="text-sm">
                    <strong>Compliance Notice:</strong> All activities must comply with applicable laws, 
                    export controls, and end-user restrictions. ITAR compliance required for defense applications.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="px-[5%] py-16 bg-[linear-gradient(180deg,transparent,rgba(0,136,255,0.05))]">
        <div className="max-w-[1400px] mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center text-[var(--primary)]">Explore Phoenix Rooivalk</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/technical" className="rounded-xl border border-[rgba(0,255,136,0.2)] bg-[rgba(15,23,42,0.8)] backdrop-blur p-6 hover:-translate-y-1 transition block">
              <h3 className="text-lg font-semibold mb-2 text-[var(--primary)]">Technical Specifications</h3>
              <p className="text-[var(--gray)] text-sm">Multi-sensor detection, neutralization modules, and deployment configurations.</p>
            </Link>
            <Link href="/financial" className="rounded-xl border border-[rgba(0,255,136,0.2)] bg-[rgba(15,23,42,0.8)] backdrop-blur p-6 hover:-translate-y-1 transition block">
              <h3 className="text-lg font-semibold mb-2 text-[var(--primary)]">Financial Projections</h3>
              <p className="text-[var(--gray)] text-sm">Revenue forecasts, break-even analysis, and investment allocation details.</p>
            </Link>
            <Link href="/compliance" className="rounded-xl border border-[rgba(0,255,136,0.2)] bg-[rgba(15,23,42,0.8)] backdrop-blur p-6 hover:-translate-y-1 transition block">
              <h3 className="text-lg font-semibold mb-2 text-[var(--primary)]">Compliance & Security</h3>
              <p className="text-[var(--gray)] text-sm">ITAR compliance, ISO certifications, and blockchain security framework.</p>
            </Link>
          </div>
        </div>
      </section>
