...
export const threatTypes: Record<string, ThreatType> = {
  drone: { emoji: '🚁', speed: 0.3, health: 1, points: 100, weakness: 'kinetic', color: '#ef4444' },
  radar: { emoji: '📡', speed: 0.2, health: 2, points: 150, weakness: 'electronic', color: '#f97316' },
  stealth: { emoji: '🛸', speed: 0.4, health: 1, points: 200, weakness: 'laser', color: '#eab308' },
  swarm: { emoji: '🐝', speed: 0.5, health: 1, points: 75, weakness: 'kinetic', color: '#8b5cf6' },
  heavy: { emoji: '🚀', speed: 0.15, health: 3, points: 300, weakness: 'laser', color: '#dc2626' }
};
