    ...
    >
      <div className="max-w-[1400px] mx-auto">
        <RevealSection className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Deploy Level-0 Autonomous Defense?</h2>
          <p className="text-[var(--gray)] max-w-2xl mx-auto">
            Join the next generation of counter-drone defense. Request capability demonstration or download technical whitepaper.
          </p>
        </RevealSection>
        ...
        <RevealSection className="grid md:grid-cols-2 gap-8">
          <div className="bg-gray-900/50 border border-gray-700/50 rounded-lg p-8">
            ...
            <div className="space-y-4">
              ...
              <Button href="mailto:partnerships@phoenixrooivalk.com" variant="outline" size="lg" className="w-full">
          ...
          <div className="bg-gray-900/50 border border-gray-700/50 rounded-lg p-8">
            ...
            <p className="text-gray-300 mb-6">
              Download comprehensive technical documentation and market analysis. 
              Learn about Level-0 architecture, market opportunity, and competitive positioning.
            </p>
            <div className="space-y-4">
              <Button onClick={downloadWhitepaper} size="lg" className="w-full">
                Download Technical Whitepaper
              </Button>
              <Button href="/technical" variant="outline" size="lg" className="w-full">
        ...
        <RevealSection className="text-center mt-12">
          <div className="bg-gradient-to-r from-[var(--primary)]/10 to-[var(--secondary)]/10 border border-[var(--primary)]/30 rounded-lg p-8">
            <h3 className="text-2xl font-bold text-white mb-4">SBIR & Government Opportunities</h3>
            <p className="text-gray-300 mb-6">
              Phoenix Rooivalk is actively pursuing Air Force SBIR Phase I ($350K) and seeking partnerships 
              with defense contractors for market entry. Contact us for SBIR collaboration or government contracting opportunities.
            </p>
