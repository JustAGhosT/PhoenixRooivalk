      ...
      <div className="max-w-[1400px] mx-auto">
        <RevealSection className="text-center mb-8">
          ...
          <p className="text-[var(--gray)] max-w-3xl mx-auto">
            <strong className="text-white">Tier 1 (Core):</strong> Autonomous edge operation with sub-second response. 
            <strong className="text-white"> Tier 2 (Enhanced):</strong> AI and intelligence when network available. 
            <strong className="text-white"> Tier 3 (Strategic):</strong> Analytics and compliance reporting.
          </p>
        </RevealSection>
