...
export const MarketIntelligenceSection: React.FC = () => {
  ...
  return (
    <section
      className="px-6 md:px-[5%] lg:px-[5%] py-12 bg-[linear-gradient(180deg,rgba(0,136,255,0.05),rgba(0,255,136,0.05))]"
      id="market"
    >
        ...
        <RevealSection>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {competitors.map((competitor, index) => (
              <div
                key={index}
                className="bg-gray-900/30 border border-gray-700/50 rounded-lg p-6"
              >
