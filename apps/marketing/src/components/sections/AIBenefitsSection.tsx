    ...
    >
      <div className="max-w-[1400px] mx-auto">
        <RevealSection className="text-center mb-8">
          <div className="inline-block bg-primary text-black px-4 py-2 rounded-full text-sm font-bold mb-4">
        ...
        <RevealSection className="text-center mt-8">
          <div className="bg-[rgba(0,255,136,0.1)] border border-primary/30 rounded-xl p-6 max-w-4xl mx-auto">
...
const MetricCard: React.FC<{
  ...
  <div className="flex items-center justify-between p-4 bg-[rgba(0,255,136,0.1)] border border-primary/30 rounded-lg">
    <div>
