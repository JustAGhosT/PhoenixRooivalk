...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary:
      "bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-lg hover:shadow-xl hover:shadow-blue-500/30 transform hover:scale-105",
    secondary:
