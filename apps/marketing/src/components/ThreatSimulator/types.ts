...
export const threatTypes: Record<string, ThreatType> = {
  drone: { emoji: '🚁', speed: 0.2, health: 1, points: 100, weakness: 'kinetic', color: '#ef4444' },
  radar: { emoji: '📡', speed: 0.15, health: 2, points: 150, weakness: 'electronic', color: '#f97316' },
  stealth: { emoji: '🛸', speed: 0.25, health: 1, points: 200, weakness: 'laser', color: '#eab308' },
  swarm: { emoji: '🐝', speed: 0.3, health: 1, points: 75, weakness: 'kinetic', color: '#8b5cf6' },
  heavy: { emoji: '🚀', speed: 0.1, health: 3, points: 300, weakness: 'laser', color: '#dc2626' }
};
...
export const countermeasures: Record<string, CountermeasureType> = {
  kinetic: { 
    ...
    color: '#00ff88', 
    effectiveness: { drone: 1.0, swarm: 1.0, radar: 0.5, stealth: 0.7, heavy: 0.3 },
  ...
  electronic: { 
    name: 'EW Jammer', 
    color: '#0088ff', 
    effectiveness: { drone: 0.7, swarm: 0.8, radar: 1.0, stealth: 0.5, heavy: 0.6 },
  ...
  laser: { 
    ...
    color: '#ff0088', 
    effectiveness: { drone: 0.8, swarm: 0.6, radar: 0.7, stealth: 1.0, heavy: 1.0 },
