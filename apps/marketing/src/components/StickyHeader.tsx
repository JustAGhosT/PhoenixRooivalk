    ...
    <header className="fixed top-0 left-0 right-0 bg-black/90 backdrop-blur-md z-50 transition-all duration-300 transform-gpu">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-6">
          <a href="#capabilities" className="text-white hover:text-green-400 transition-colors">Capabilities</a>
          <a href="#ai-benefits" className="text-white hover:text-green-400 transition-colors">AI Benefits</a>
          <a href="#market" className="text-white hover:text-green-400 transition-colors">Market</a>
          <a href="#credibility" className="text-white hover:text-green-400 transition-colors">Credibility</a>
