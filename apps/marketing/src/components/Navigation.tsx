                ...
                <div className={styles.githubDropdownInner}>
                  ...
                  >
                    ...
                    <div className={styles.githubDropdownContent}>
                      <div className={styles.githubDropdownTitle}>Phoenix Rooivalk</div>
                  ...
                  >
                    ...
                    <div className={styles.githubDropdownContent}>
                      <div className={styles.githubDropdownTitle}>Cognitive Mesh</div>
                      <div className={styles.githubDropdownDesc}>
                        AI integration
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div className={styles.githubDropdownContent}>
                      <div className={styles.githubDropdownTitle}>Documentation</div>
                      <div className={styles.githubDropdownDesc}>
                        Technical docs
                      </div>
                    </div>
