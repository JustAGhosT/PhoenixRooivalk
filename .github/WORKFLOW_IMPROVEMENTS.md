...
This document outlines a comprehensive plan to improve the GitHub Actions workflows for the Phoenix Rooivalk project, organized into implementation phases.
  ...
  - name: Cache build outputs
    ...
    with:
      path: |
        apps/marketing/out
        apps/docs/build
      key: ${{ runner.os }}-build-${{ hashFiles('**/package.json', '**/pnpm-lock.yaml') }}
  ```
...
*Last Updated: $(date)*
*Maintained by: Phoenix Rooivalk Team*
